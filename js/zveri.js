document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch('xml/zveri.xml')
      ...
      .catch(error => {
        ...
        document.getElementById("movie-display").textContent = "Когда ваш хорёк сбежал наутёк, когда носороги сделали ноги, когда ваш шакал куда-то слинял — вам нужен свин-зверолов. Ему нет равных в поиске сбежавших животных, поэтому именно к нему обращается шоумен из Лас-Вегаса с просьбой вернуть цирковую слониху Пикулю.";
