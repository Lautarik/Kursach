document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch('xml/fury.xml')
      ...
      .catch(error => {
        ...
        document.getElementById("movie-display").textContent = "Действие фильма разворачивается в конце Второй мировой войны в нацистской Германии. Группа американских солдат планирует дерзкую военную операцию.";
